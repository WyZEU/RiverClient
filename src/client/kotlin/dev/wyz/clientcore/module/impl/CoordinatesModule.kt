...
class CoordinatesModule : Module("coordinates", "Coordinates", "Your position, biome and more", ModuleCategory.HUD, "location", 8, 26) {
    ...
    override val multiLine: Boolean
        get() = showBiome() || showEntities() || showDimension() || showLight()
    ...
    override fun render(client: Minecraft, graphics: GuiGraphics, tickDelta: Float) {
        ...
        drawCoords(client, graphics, rows, facing(player.yRot))
    }
    ...
    override fun renderEditorPreview(client: Minecraft, graphics: GuiGraphics, tickDelta: Float) {
        ...
        drawCoords(client, graphics, rows, "NE")
    }
