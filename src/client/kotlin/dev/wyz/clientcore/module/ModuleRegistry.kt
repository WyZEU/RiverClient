...
import dev.wyz.clientcore.module.impl.StatsModule
import dev.wyz.clientcore.module.impl.TimeModule
...
object ModuleRegistry {
    ...
    fun bootstrap() {
        ...
        register(ContainerPreviewModule())
...
//? if >=1.21.6 {
                pose.pushMatrix()
                pose.translate(module.x.toFloat(), module.y.toFloat())
