...
//?}
        ...
        // Preview swatch.
        val swX = boxX + boxW + 8
        ClientUi.fillRounded(g, swX, rowY, 34, 18, ClientUi.RADIUS_CARD, (0xFF shl 24) or currentRgb())
...
/*    override fun mouseDragged(mouseX: Double, mouseY: Double, button: Int, dragX: Double, dragY: Double): Boolean {
        if (dragSv) { updateSv(mouseX.toInt(), mouseY.toInt()); return true }
        if (dragHue) { updateHue(mouseY.toInt()); return true }
...
//?} else {
/*            val filtered = codePoint.toString().filter { it.isDigit() || it.lowercaseChar() in 'a'..'f' }
*///?}
