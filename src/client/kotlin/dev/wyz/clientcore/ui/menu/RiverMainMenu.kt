...
object RiverMainMenu {
    ...
    private fun loadTexture(path: String, name: String): Triple<Identifier, Int, Int>? = runCatching {
        ...
        val id = Identifier.fromNamespaceAndPath("clientcore", name)
    ...
    fun renderBackground(client: Minecraft, g: GuiGraphics) {
        ...
        if (bg != null && bgW > 0 && bgH > 0) {
            ...
            g.blit(RenderPipelines.GUI_TEXTURED, bg, 0, 0, u, v, w, h, srcW.roundToInt(), srcH.roundToInt(), bgW, bgH)
        } else {
    ...
    fun render(screen: TitleScreen, client: Minecraft, g: GuiGraphics, mouseX: Int, mouseY: Int) {
        ...
        titleTex?.let { tex ->
            ...
            g.blit(RenderPipelines.GUI_TEXTURED, tex, tx, ty, 0f, 0f, drawW, drawH, titleW, titleH, titleW, titleH, tint)
    ...
    private fun drawIconButton(
        ...
        if (button.icon != null) {
            ...
            g.blit(RenderPipelines.GUI_TEXTURED, logo, ix, iy, 0f, 0f, size, size, 500, 500, 500, 500, tint)
        } else {
