...
async function bundle() {
  ...
  */
  ...
  fs.writeFileSync(path.join(out, "renderer", "updater.html"), shell("River Client Updater", "updater"));
  fs.writeFileSync(path.join(out, "renderer", "logs.html"), shell("River Client - Game log", "logs"));
}
