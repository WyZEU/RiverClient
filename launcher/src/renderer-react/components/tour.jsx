...
const STEPS = [
  {
    ...
    body: "Quick tour of where things are. Replayable from Settings."
  },
  {
    target: "launch",
    view: "home",
    title: "Launch the game",
    body: "Starts Minecraft with River loaded."
  },
  {
    target: "rail-home",
    view: "home",
    title: "Home",
    body: "Servers you play show up here. Join to launch straight in."
  },
  {
    target: "rail-instances",
    view: "instances",
    title: "Instances",
    body: "Separate setups, each with its own mods and worlds."
  },
  {
    target: "rail-wardrobe",
    view: "wardrobe",
    title: "Wardrobe",
    body: "Skins and capes. Cosmetic only."
  },
  {
    target: "rail-settings",
    view: "settings",
    title: "Settings",
    body: "Memory, theme, account, updates."
  }
];
