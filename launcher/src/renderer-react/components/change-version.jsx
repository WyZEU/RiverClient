          ...
          {plan ? (
            <div className="space-y-4">
              {group(plan.update || [], "text-success", RefreshCw, "Will be updated",
                "These have a build for the new version and will be updated automatically.")}
              {group(plan.keep || [], "text-muted-foreground", CheckCircle2, "Already compatible",
                "These already work on both versions and will be left alone.")}
              {group(willDisable, "text-warning", PauseCircle, "Will be turned off",
                "No build for the new version, so these would break the game. They are disabled, not deleted - switch back and they return.")}
