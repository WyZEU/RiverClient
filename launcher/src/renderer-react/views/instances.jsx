...
export function InstancesView({ status, refresh, notify, openInstance }) {
  ...
  return (
    <Page
      title="Instances"
      description="Each instance keeps its own mods, worlds and settings."
      actions={
        <>
    ...
    >
      {instances.length ? (
        ...
        <EmptyState
          icon={Boxes}
          title="No instances"
          description="Create one to keep separate mod setups side by side."
