...
export function WardrobeView({ status, refresh, notify }) {
  ...
  if (!signedIn) {
    return (
      <Page title="Wardrobe" description="Skins and capes for your Microsoft account.">
        <EmptyState
          icon={LogIn}
          title="Sign in to use the wardrobe"
          description="Skins and capes are tied to your Microsoft account."
        ...
        <TabsContent value="skins">
          {skins.length ? (
            ...
            <EmptyState
              icon={Shirt}
              title="No skins yet"
              description="Upload a skin PNG to start your wardrobe."
        ...
        <TabsContent value="capes">
          {capes.length ? (
            ...
            <EmptyState
              ...
              description="Capes unlocked on your Microsoft account show up here."
            />
          )}
        </TabsContent>
      </Tabs>
