...
object ClientUi {
    ...
    private fun drawTexturedToggle(g: GuiGraphics, key: String, x: Int, y: Int, trackW: Int, trackH: Int, knobSize: Int, on: Boolean, hovered: Boolean) {
        ...
        if (track != null && knob != null) {
            g.blit(net.minecraft.client.renderer.RenderType::guiTextured, track, x, y, 0f, 0f, trackW, trackH, 136, 56, 136, 56, trackTint)
            g.blit(net.minecraft.client.renderer.RenderType::guiTextured, knob, knobX, knobY, 0f, 0f, knobSize, knobSize, 48, 48, 48, 48, 0xFFFFFFFF.toInt())
        } else {
