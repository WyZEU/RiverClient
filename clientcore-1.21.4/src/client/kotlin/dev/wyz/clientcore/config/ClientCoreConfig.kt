...
data class ClientCoreConfig(
    ...
    /** Server address (lowercased) -> module ids disabled on that server. */
    var serverBlocked: MutableMap<String, MutableList<String>>? = null,
    ...
    fun serverBlockedMap(): MutableMap<String, MutableList<String>> {
        if (serverBlocked == null) serverBlocked = mutableMapOf()
